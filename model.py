...
class DCGAN(object):
  def __init__(self, sess, input_height=108, input_width=108, crop=True,
         ...
         input_fname_pattern='*.jpg', checkpoint_dir=None, sample_dir=None, three_layers=False):
    """
    ...
    """
    self.generator = self.generator_4layers
    self.discriminator = self.discriminator_4layers
    self.sampler = self.sampler_4layers
    if three_layers:
      self.generator = self.generator_3layers
      self.discriminator = self.discriminator_3layers
      self.sampler = self.sampler_3layers
  ...
  def discriminator_4layers(self, image, y=None, reuse=False):
  ...
  def discriminator_3layers(self, image, y=None, reuse=False):
    with tf.variable_scope("discriminator") as scope:
      if reuse:
        scope.reuse_variables()
  ...
  def generator_4layers(self, z, y=None):
  ...
  def generator_3layers(self, z, y=None):
    with tf.variable_scope("generator") as scope:
      s_h, s_w = self.output_height, self.output_width
      s_h2, s_w2 = conv_out_size_same(s_h, 2), conv_out_size_same(s_w, 2)
      s_h4, s_w4 = conv_out_size_same(s_h2, 2), conv_out_size_same(s_w2, 2)
  ...
  def sampler_4layers(self, z, y=None):
    with tf.variable_scope("generator") as scope:
      scope.reuse_variables()
  ...
  def sampler_3layers(self, z, y=None):
    with tf.variable_scope("generator") as scope:
      scope.reuse_variables()
